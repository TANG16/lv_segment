...
% load dia workspace
imdsTrain.Files = [imdsTrain.Files; sysImdsTrain];
imdsTest.Files = [imdsTest.Files; sysImdsTest];
pxdsTrain.Files = [pxdsTrain.Files; sysPxdsTrain];
pxdsTest.Files = [pxdsTest.Files; sysPxdsTest];

tblDia = countEachlabal(pxds);
...
%%
% Choices
saveSetPath = uigetdir('*.mat', 'Choose a path to save the networks into.');
mkdir(saveSetPath);
