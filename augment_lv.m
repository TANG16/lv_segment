function augment_lv(IM, MASK)
%-------------------------------------------------
% Script to apply augmentation on exported short-axis images of the left
% ventricle. A .mat file will save the files as png images into a folder
% chosen below.
%
